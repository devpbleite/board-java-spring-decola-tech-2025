...
import pbleite.dev.board.dto.BoardColumnInfoDTO;
import pbleite.dev.board.exception.CardBlockedException;
import pbleite.dev.board.exception.CardFinishedException;
import pbleite.dev.board.exception.EntityNotFoundException;
import pbleite.dev.board.persistence.dao.BlockDAO;
import pbleite.dev.board.persistence.dao.CardDAO;
import pbleite.dev.board.persistence.entity.CardEntity;

import java.sql.Connection;
import java.sql.SQLException;
import java.util.List;

import static pbleite.dev.board.persistence.entity.BoardColumnKindEnum.CANCEL;
import static pbleite.dev.board.persistence.entity.BoardColumnKindEnum.FINAL;
